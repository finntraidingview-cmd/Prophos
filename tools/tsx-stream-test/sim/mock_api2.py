...
T0 = time.time(); FENSTER = [(8, 18), (26, 36)]
class H(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if self.path.endswith("/api/Position/searchOpen"):
            pos = [{"id": 1, "accountId": 27613403, "contractId": "CON.F.US.MNQ.Z26", "creationTimestamp": "2026-09-17T10:19:35Z", "type": 1, "size": 1, "averagePrice": 29565.5}] if any(a <= t < z for a, z in FENSTER) else []
